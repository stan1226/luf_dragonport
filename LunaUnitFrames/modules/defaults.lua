			...
			player = {
				...
				indicators = {
					...
					icons = {
						...
						dragonport = { enabled = false, anchorPoint = "LEFT", size = 80, x = 14, y = -4 },
						dragoneliteport = { enabled = false, anchorPoint = "LEFT", size = 80, x = 14, y = -4 }
					},
				},
				borders = {
					enabled = false,
			...
			target = {
				...
				indicators = {
					...
					icons = {
						...
						dragonport = { enabled = false, anchorPoint = "RIGHT", size = 80, x = -14, y = -4 },
						dragoneliteport = { enabled = false, anchorPoint = "RIGHT", size = 80, x = -14, y = -4 },
